...
<body>
  ...
  <div class="d-flex" id="wrapper">
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="sidebar-heading" style="font-size: 22px;"><img src="images/notekeeper.png" alt="logo" style="width: 45px; height: 45px;">&ensp;Note Keeper</div>
      <div class="list-group list-group-flush">
        <a href="update_navbar.php?destroy=true" class="list-group-item list-group-item-action"><i class="fa fa-sticky-note" aria-hidden="true"></i>&ensp;&ensp;Notes</a>
        <a href="#" class="list-group-item list-group-item-action bg-light" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-plus" aria-hidden="true"></i>&ensp;&ensp;Add Note</a>
        <a href="#" class="list-group-item list-group-item-action bg-light" data-toggle="modal" data-target="#exampleModal2"><i class="fa fa-tag" aria-hidden="true"></i>&ensp;&ensp;Add Label</a>
        <a href="update_navbar.php?archive=Archive" class="list-group-item list-group-item-action bg-light"><i class="fa fa-archive" aria-hidden="true"></i>&ensp;&ensp;Archive</a>
        <a href="update_navbar.php?bin=Bin" class="list-group-item list-group-item-action bg-light"><i class="fa fa-trash" aria-hidden="true"></i>&ensp;&ensp;Bin</a>
      </div>
    </div>
          ...
          if(isset($_SESSION['archive'])) {
            ...
            if($result->num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                ...
                echo "<h5 class='text-danger'>Empty</h5>";
            }
          }
          if(isset($_SESSION['bin'])) {
